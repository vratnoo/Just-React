...
const Navigation = (props)=>{
    ...
    return(
        ...
        <header className="sticky top-0 z-50 w-full bg-white border-b-2 border-b-slate-200">

            <div className="container mx-auto h-16 flex sm:justify-between items-center">
            <nav className='flex gap-6 md:gap-10 items-center justify-start'>
                <a href="" className="text-md font-semibold flex  py-3 text-gray-900">
                    <AcademicCapIcon className='h-6 w-6 mr-2 text-indigo-800'/>
                    Expanse Manager</a>
            ...
            <div className="flex items-center justify-end">
                <nav className='flex items-center'>
                    <a href="" className="">
                        <div className='hover:bg-gray-100 h-9 w-9 flex items-center justify-center rounded-md '>
